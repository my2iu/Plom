...
public class FindTokenTest extends TestCase
{
  ...
  public void testTokenToPosition()
  {
    ...
    pos = CodePosition.fromOffsets(0, 2, CodeRenderer.PARAMTOK_POS_EXPRS, 1, 1);
    token = GetToken.inStatements(code, pos, 0);
    ...
    pos = CodePosition.fromOffsets(2, 1, CodeRenderer.EXPRBLOCK_POS_BLOCK, 0, 1);
    token = GetToken.inStatements(code, pos, 0);
    ...
    pos = CodePosition.fromOffsets(2, 0, CodeRenderer.EXPRBLOCK_POS_EXPR, 0);
    token = GetToken.inStatements(code, pos, 0);
    ...
    // Comment
    pos = CodePosition.fromOffsets(2, 0, CodeRenderer.EXPRBLOCK_POS_BLOCK, 1, 0);
    token = GetToken.inStatements(code, pos, 0);
