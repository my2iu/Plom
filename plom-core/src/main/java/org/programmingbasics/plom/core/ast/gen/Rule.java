...
public class Rule
{
	...
	public final static List<Symbol> RelationalExpressionMore_Retype_Type_RelationalExpressionMore = Arrays.asList(Symbol.RelationalExpressionMore, Symbol.Retype, Symbol.Type, Symbol.RelationalExpressionMore);
	...
	public final static List<Symbol> RelationalExpressionMore_Is_Type_RelationalExpressionMore = Arrays.asList(Symbol.RelationalExpressionMore, Symbol.Is, Symbol.Type, Symbol.RelationalExpressionMore);
	...
	public final static List<Symbol> MemberExpressionMore_As_Type_MemberExpressionMore = Arrays.asList(Symbol.MemberExpressionMore, Symbol.As, Symbol.Type, Symbol.MemberExpressionMore);
	...
	public final static List<Symbol> VarType_Type = Arrays.asList(Symbol.VarType, Symbol.Type);
	...
	public final static List<Symbol> ParameterFieldOptionalName_Type = Arrays.asList(Symbol.ParameterFieldOptionalName, Symbol.Type);
	public final static List<Symbol> ParameterFieldOptionalNameOnly_ParameterFieldOptionalName_EndStatement = Arrays.asList(Symbol.ParameterFieldOptionalNameOnly, Symbol.ParameterFieldOptionalName, Symbol.EndStatement);
