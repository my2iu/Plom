...
public class Parser
{
	public Map<Symbol, Map<Symbol, Symbol[]>> parsingTable = new HashMap<>();
	{
		...
		parsingTable.put(Symbol.OptionalComment, new HashMap<>());
		parsingTable.get(Symbol.OptionalComment).put(Symbol.Number, new Symbol[] {});
		parsingTable.get(Symbol.OptionalComment).put(Symbol.DUMMY_COMMENT, new Symbol[] {Symbol.DUMMY_COMMENT, Symbol.OptionalComment, });
		parsingTable.get(Symbol.OptionalComment).put(Symbol.EndStatement, new Symbol[] {});
		parsingTable.get(Symbol.OptionalComment).put(Symbol.COMPOUND_ELSE, new Symbol[] {});
		parsingTable.get(Symbol.OptionalComment).put(Symbol.COMPOUND_IF, new Symbol[] {});
		parsingTable.get(Symbol.OptionalComment).put(Symbol.COMPOUND_ELSEIF, new Symbol[] {});
		parsingTable.get(Symbol.OptionalComment).put(Symbol.OpenParenthesis, new Symbol[] {});
		parsingTable.get(Symbol.OptionalComment).put(Symbol.String, new Symbol[] {});
		...
		parsingTable.get(Symbol.AfterIf).put(Symbol.Number, new Symbol[] {Symbol.StatementNoComment, Symbol.EndStatement, });
		parsingTable.get(Symbol.AfterIf).put(Symbol.EndStatement, new Symbol[] {Symbol.StatementNoComment, Symbol.EndStatement, });
		parsingTable.get(Symbol.AfterIf).put(Symbol.COMPOUND_ELSE, new Symbol[] {Symbol.IfMore, Symbol.Statement, Symbol.EndStatement, });
		parsingTable.get(Symbol.AfterIf).put(Symbol.COMPOUND_ELSEIF, new Symbol[] {Symbol.IfMore, Symbol.Statement, Symbol.EndStatement, });
		parsingTable.get(Symbol.AfterIf).put(Symbol.COMPOUND_IF, new Symbol[] {Symbol.StatementNoComment, Symbol.EndStatement, });
		parsingTable.get(Symbol.AfterIf).put(Symbol.OpenParenthesis, new Symbol[] {Symbol.StatementNoComment, Symbol.EndStatement, });
		parsingTable.get(Symbol.AfterIf).put(Symbol.String, new Symbol[] {Symbol.StatementNoComment, Symbol.EndStatement, });
		...
		parsingTable.get(Symbol.IfMore).put(Symbol.COMPOUND_ELSEIF, new Symbol[] {Symbol.COMPOUND_ELSEIF, Symbol.OptionalComment, Symbol.AfterIf, });
		...
		parsingTable.get(Symbol.Statement).put(Symbol.DUMMY_COMMENT, new Symbol[] {Symbol.DUMMY_COMMENT, Symbol.Statement, });
		parsingTable.get(Symbol.Statement).put(Symbol.Number, new Symbol[] {Symbol.StatementNoComment, Symbol.EndStatement, });
		parsingTable.get(Symbol.Statement).put(Symbol.EndStatement, new Symbol[] {Symbol.StatementNoComment, Symbol.EndStatement, });
		parsingTable.get(Symbol.Statement).put(Symbol.COMPOUND_IF, new Symbol[] {Symbol.StatementNoComment, Symbol.EndStatement, });
		parsingTable.get(Symbol.Statement).put(Symbol.OpenParenthesis, new Symbol[] {Symbol.StatementNoComment, Symbol.EndStatement, });
		parsingTable.get(Symbol.Statement).put(Symbol.String, new Symbol[] {Symbol.StatementNoComment, Symbol.EndStatement, });
		parsingTable.put(Symbol.StatementNoComment, new HashMap<>());
		parsingTable.get(Symbol.StatementNoComment).put(Symbol.Number, new Symbol[] {Symbol.Expression, });
		parsingTable.get(Symbol.StatementNoComment).put(Symbol.EndStatement, new Symbol[] {});
		parsingTable.get(Symbol.StatementNoComment).put(Symbol.COMPOUND_IF, new Symbol[] {Symbol.COMPOUND_IF, Symbol.OptionalComment, Symbol.AfterIf, });
		parsingTable.get(Symbol.StatementNoComment).put(Symbol.OpenParenthesis, new Symbol[] {Symbol.Expression, });
		parsingTable.get(Symbol.StatementNoComment).put(Symbol.String, new Symbol[] {Symbol.Expression, });
