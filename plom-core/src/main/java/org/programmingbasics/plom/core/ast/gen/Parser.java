...
public class Parser
{
	public Map<Symbol, Map<Symbol, Symbol[]>> parsingTable = new HashMap<>();
	{
		...
		parsingTable.get(Symbol.VarType).put(Symbol.Colon, new Symbol[] {Symbol.Colon, Symbol.DotType, });
		parsingTable.get(Symbol.VarType).put(Symbol.Assignment, new Symbol[] {});
		parsingTable.put(Symbol.DotType, new HashMap<>());
		parsingTable.get(Symbol.DotType).put(Symbol.DotVariable, new Symbol[] {Symbol.DotVariable, });
	}
}
