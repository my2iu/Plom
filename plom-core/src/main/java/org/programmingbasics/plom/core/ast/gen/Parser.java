...
public class Parser
{
	public Map<Symbol, Map<Symbol, Symbol[]>> parsingTable = new HashMap<>();
	{
		...
		parsingTable.get(Symbol.ForExpression).put(Symbol.DotVariable, new Symbol[] {Symbol.DotDeclareIdentifier, Symbol.VarType, Symbol.In, Symbol.Expression, Symbol.EndStatement, });
	}
}
