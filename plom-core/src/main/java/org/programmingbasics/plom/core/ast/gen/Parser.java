...
public class Parser
{
	public Map<Symbol, Map<Symbol, Symbol[]>> parsingTable = new HashMap<>();
	{
		...
		parsingTable.get(Symbol.AdditiveExpression).put(Symbol.FunctionLiteral, new Symbol[] {Symbol.MultiplicativeExpression, Symbol.AdditiveExpressionMore, });
		...
		parsingTable.get(Symbol.AdditiveExpression).put(Symbol.Super, new Symbol[] {Symbol.MultiplicativeExpression, Symbol.AdditiveExpressionMore, });
		...
		parsingTable.get(Symbol.AfterIf).put(Symbol.Break, new Symbol[] {});
		...
		parsingTable.get(Symbol.AfterIf).put(Symbol.Continue, new Symbol[] {});
		...
		parsingTable.get(Symbol.AfterIf).put(Symbol.FunctionLiteral, new Symbol[] {});
		...
		parsingTable.get(Symbol.AfterIf).put(Symbol.Super, new Symbol[] {});
		...
		parsingTable.get(Symbol.AndExpression).put(Symbol.FunctionLiteral, new Symbol[] {Symbol.RelationalExpression, Symbol.AndExpressionMore, });
		...
		parsingTable.get(Symbol.AndExpression).put(Symbol.Super, new Symbol[] {Symbol.RelationalExpression, Symbol.AndExpressionMore, });
		...
		parsingTable.get(Symbol.AssignmentExpression).put(Symbol.FunctionLiteral, new Symbol[] {Symbol.Expression, Symbol.AssignmentExpressionMore, });
		...
		parsingTable.get(Symbol.AssignmentExpression).put(Symbol.Super, new Symbol[] {Symbol.Expression, Symbol.AssignmentExpressionMore, });
		...
		parsingTable.put(Symbol.DotSuperMember, new HashMap<>());
		parsingTable.get(Symbol.DotSuperMember).put(Symbol.DotVariable, new Symbol[] {Symbol.DotVariable, });
		...
		parsingTable.get(Symbol.Expression).put(Symbol.FunctionLiteral, new Symbol[] {Symbol.OrExpression, });
		...
		parsingTable.get(Symbol.Expression).put(Symbol.Super, new Symbol[] {Symbol.OrExpression, });
		...
		parsingTable.get(Symbol.ExpressionOnly).put(Symbol.FunctionLiteral, new Symbol[] {Symbol.Expression, Symbol.EndStatement, });
		...
		parsingTable.get(Symbol.ExpressionOnly).put(Symbol.Super, new Symbol[] {Symbol.Expression, Symbol.EndStatement, });
		...
		parsingTable.get(Symbol.FullStatement).put(Symbol.Break, new Symbol[] {Symbol.StatementOrEmpty, Symbol.EndStatement, });
		...
		parsingTable.get(Symbol.FullStatement).put(Symbol.Continue, new Symbol[] {Symbol.StatementOrEmpty, Symbol.EndStatement, });
		...
		parsingTable.get(Symbol.FullStatement).put(Symbol.FunctionLiteral, new Symbol[] {Symbol.StatementOrEmpty, Symbol.EndStatement, });
		...
		parsingTable.get(Symbol.FullStatement).put(Symbol.Super, new Symbol[] {Symbol.StatementOrEmpty, Symbol.EndStatement, });
		...
		parsingTable.put(Symbol.FullVariableDeclaration, new HashMap<>());
		...
		parsingTable.get(Symbol.FunctionLiteralExpression).put(Symbol.FunctionTypeName, new Symbol[] {Symbol.FunctionType, });
		...
		parsingTable.get(Symbol.MemberExpression).put(Symbol.FunctionLiteral, new Symbol[] {Symbol.ParenthesisExpression, Symbol.MemberExpressionMore, });
		...
		parsingTable.get(Symbol.MemberExpression).put(Symbol.Super, new Symbol[] {Symbol.ParenthesisExpression, Symbol.MemberExpressionMore, });
		...
		parsingTable.get(Symbol.MemberExpressionMore).put(Symbol.As, new Symbol[] {Symbol.As, Symbol.Type, Symbol.MemberExpressionMore, });
		...
		parsingTable.get(Symbol.MultiplicativeExpression).put(Symbol.FunctionLiteral, new Symbol[] {Symbol.MemberExpression, Symbol.MultiplicativeExpressionMore, });
		...
		parsingTable.get(Symbol.MultiplicativeExpression).put(Symbol.Super, new Symbol[] {Symbol.MemberExpression, Symbol.MultiplicativeExpressionMore, });
		...
		parsingTable.get(Symbol.OrExpression).put(Symbol.FunctionLiteral, new Symbol[] {Symbol.AndExpression, Symbol.OrExpressionMore, });
		...
		parsingTable.get(Symbol.OrExpression).put(Symbol.Super, new Symbol[] {Symbol.AndExpression, Symbol.OrExpressionMore, });
		...
		parsingTable.get(Symbol.ParameterField).put(Symbol.DotVariable, new Symbol[] {Symbol.DotDeclareIdentifier, Symbol.Type, });
		parsingTable.put(Symbol.ParameterFieldOnly, new HashMap<>());
		parsingTable.get(Symbol.ParameterFieldOnly).put(Symbol.DotVariable, new Symbol[] {Symbol.ParameterField, Symbol.EndStatement, });
		parsingTable.put(Symbol.ParameterFieldOptionalName, new HashMap<>());
		parsingTable.get(Symbol.ParameterFieldOptionalName).put(Symbol.AtType, new Symbol[] {Symbol.Type, });
		parsingTable.get(Symbol.ParameterFieldOptionalName).put(Symbol.DotVariable, new Symbol[] {Symbol.DotDeclareIdentifier, Symbol.Type, });
		parsingTable.get(Symbol.ParameterFieldOptionalName).put(Symbol.FunctionTypeName, new Symbol[] {Symbol.Type, });
		parsingTable.put(Symbol.ParameterFieldOptionalNameOnly, new HashMap<>());
		parsingTable.get(Symbol.ParameterFieldOptionalNameOnly).put(Symbol.AtType, new Symbol[] {Symbol.ParameterFieldOptionalName, Symbol.EndStatement, });
		parsingTable.get(Symbol.ParameterFieldOptionalNameOnly).put(Symbol.DotVariable, new Symbol[] {Symbol.ParameterFieldOptionalName, Symbol.EndStatement, });
		parsingTable.get(Symbol.ParameterFieldOptionalNameOnly).put(Symbol.FunctionTypeName, new Symbol[] {Symbol.ParameterFieldOptionalName, Symbol.EndStatement, });
		...
		parsingTable.get(Symbol.ParenthesisExpression).put(Symbol.FunctionLiteral, new Symbol[] {Symbol.ValueExpression, });
		...
		parsingTable.get(Symbol.ParenthesisExpression).put(Symbol.Super, new Symbol[] {Symbol.ValueExpression, });
		...
		parsingTable.get(Symbol.RelationalExpression).put(Symbol.FunctionLiteral, new Symbol[] {Symbol.AdditiveExpression, Symbol.RelationalExpressionMore, });
		...
		parsingTable.get(Symbol.RelationalExpression).put(Symbol.Super, new Symbol[] {Symbol.AdditiveExpression, Symbol.RelationalExpressionMore, });
		...
		parsingTable.get(Symbol.RelationalExpressionMore).put(Symbol.Is, new Symbol[] {Symbol.Is, Symbol.Type, Symbol.RelationalExpressionMore, });
		...
		parsingTable.get(Symbol.RelationalExpressionMore).put(Symbol.Retype, new Symbol[] {Symbol.Retype, Symbol.Type, Symbol.RelationalExpressionMore, });
		parsingTable.put(Symbol.ReturnExpression, new HashMap<>());
		parsingTable.get(Symbol.ReturnExpression).put(Symbol.AtType, new Symbol[] {Symbol.Expression, });
		parsingTable.get(Symbol.ReturnExpression).put(Symbol.DotVariable, new Symbol[] {Symbol.Expression, });
		parsingTable.get(Symbol.ReturnExpression).put(Symbol.EndStatement, new Symbol[] {});
		parsingTable.get(Symbol.ReturnExpression).put(Symbol.FalseLiteral, new Symbol[] {Symbol.Expression, });
		parsingTable.get(Symbol.ReturnExpression).put(Symbol.FunctionLiteral, new Symbol[] {Symbol.Expression, });
		parsingTable.get(Symbol.ReturnExpression).put(Symbol.NullLiteral, new Symbol[] {Symbol.Expression, });
		parsingTable.get(Symbol.ReturnExpression).put(Symbol.Number, new Symbol[] {Symbol.Expression, });
		parsingTable.get(Symbol.ReturnExpression).put(Symbol.OpenParenthesis, new Symbol[] {Symbol.Expression, });
		parsingTable.get(Symbol.ReturnExpression).put(Symbol.String, new Symbol[] {Symbol.Expression, });
		parsingTable.get(Symbol.ReturnExpression).put(Symbol.Super, new Symbol[] {Symbol.Expression, });
		parsingTable.get(Symbol.ReturnExpression).put(Symbol.This, new Symbol[] {Symbol.Expression, });
		parsingTable.get(Symbol.ReturnExpression).put(Symbol.TrueLiteral, new Symbol[] {Symbol.Expression, });
		parsingTable.put(Symbol.ReturnStatement, new HashMap<>());
		parsingTable.get(Symbol.ReturnStatement).put(Symbol.Return, new Symbol[] {Symbol.Return, Symbol.ReturnExpression, });
		parsingTable.put(Symbol.ReturnTypeField, new HashMap<>());
		parsingTable.get(Symbol.ReturnTypeField).put(Symbol.AtType, new Symbol[] {Symbol.Type, });
		parsingTable.get(Symbol.ReturnTypeField).put(Symbol.FunctionTypeName, new Symbol[] {Symbol.Type, });
		...
		parsingTable.get(Symbol.Statement).put(Symbol.Break, new Symbol[] {Symbol.Break, });
		...
		parsingTable.get(Symbol.Statement).put(Symbol.Continue, new Symbol[] {Symbol.Continue, });
		...
		parsingTable.get(Symbol.Statement).put(Symbol.FunctionLiteral, new Symbol[] {Symbol.AssignmentExpression, });
		...
		parsingTable.get(Symbol.Statement).put(Symbol.Super, new Symbol[] {Symbol.AssignmentExpression, });
		...
		parsingTable.get(Symbol.StatementOrEmpty).put(Symbol.Break, new Symbol[] {Symbol.Statement, });
		...
		parsingTable.get(Symbol.StatementOrEmpty).put(Symbol.Continue, new Symbol[] {Symbol.Statement, });
		...
		parsingTable.get(Symbol.StatementOrEmpty).put(Symbol.FunctionLiteral, new Symbol[] {Symbol.Statement, });
		...
		parsingTable.get(Symbol.StatementOrEmpty).put(Symbol.Super, new Symbol[] {Symbol.Statement, });
		...
		parsingTable.get(Symbol.Type).put(Symbol.AtType, new Symbol[] {Symbol.AtType, });
		parsingTable.get(Symbol.Type).put(Symbol.FunctionTypeName, new Symbol[] {Symbol.FunctionType, });
		parsingTable.put(Symbol.TypeOnly, new HashMap<>());
		parsingTable.get(Symbol.TypeOnly).put(Symbol.AtType, new Symbol[] {Symbol.Type, Symbol.EndStatement, });
		parsingTable.get(Symbol.TypeOnly).put(Symbol.FunctionTypeName, new Symbol[] {Symbol.Type, Symbol.EndStatement, });
		...
		parsingTable.get(Symbol.ValueExpression).put(Symbol.FunctionLiteral, new Symbol[] {Symbol.FunctionLiteral, });
		...
		parsingTable.get(Symbol.ValueExpression).put(Symbol.Super, new Symbol[] {Symbol.SuperCallExpression, });
		...
		parsingTable.put(Symbol.VarDeclarationStatement, new HashMap<>());
		parsingTable.get(Symbol.VarDeclarationStatement).put(Symbol.Var, new Symbol[] {Symbol.Var, Symbol.DotDeclareIdentifier, Symbol.VarType, });
		...
		parsingTable.get(Symbol.VarType).put(Symbol.AtType, new Symbol[] {Symbol.Type, });
		parsingTable.get(Symbol.VarType).put(Symbol.EndStatement, new Symbol[] {});
		parsingTable.get(Symbol.VarType).put(Symbol.FunctionTypeName, new Symbol[] {Symbol.Type, });
		parsingTable.get(Symbol.VarType).put(Symbol.In, new Symbol[] {});
		parsingTable.put(Symbol.VariableDeclaration, new HashMap<>());
		parsingTable.get(Symbol.VariableDeclaration).put(Symbol.DUMMY_COMMENT, new Symbol[] {Symbol.DUMMY_COMMENT, Symbol.VariableDeclarationOrEmpty, });
		parsingTable.get(Symbol.VariableDeclaration).put(Symbol.Var, new Symbol[] {Symbol.VarDeclarationStatement, });
		parsingTable.put(Symbol.VariableDeclarationOrEmpty, new HashMap<>());
		parsingTable.get(Symbol.VariableDeclarationOrEmpty).put(Symbol.DUMMY_COMMENT, new Symbol[] {Symbol.VariableDeclaration, });
