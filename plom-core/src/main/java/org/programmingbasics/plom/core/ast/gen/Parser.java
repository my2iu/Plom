...
public class Parser
{
	public Map<Symbol, Map<Symbol, Symbol[]>> parsingTable = new HashMap<>();
	{
		...
		parsingTable.get(Symbol.Expression).put(Symbol.String, new Symbol[] {Symbol.RelationalExpression, });
		parsingTable.get(Symbol.Expression).put(Symbol.TrueLiteral, new Symbol[] {Symbol.RelationalExpression, });
		parsingTable.get(Symbol.Expression).put(Symbol.DotVariable, new Symbol[] {Symbol.RelationalExpression, });
		parsingTable.get(Symbol.Expression).put(Symbol.OpenParenthesis, new Symbol[] {Symbol.RelationalExpression, });
		parsingTable.get(Symbol.Expression).put(Symbol.Number, new Symbol[] {Symbol.RelationalExpression, });
		parsingTable.get(Symbol.Expression).put(Symbol.FalseLiteral, new Symbol[] {Symbol.RelationalExpression, });
