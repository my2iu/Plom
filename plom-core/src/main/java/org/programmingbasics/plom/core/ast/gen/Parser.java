...
public class Parser
{
	public Map<Symbol, Map<Symbol, Symbol[]>> parsingTable = new HashMap<>();
	{
		...
		parsingTable.get(Symbol.Statement).put(Symbol.DUMMY_COMMENT, new Symbol[] {Symbol.DUMMY_COMMENT, Symbol.StatementNoComment, Symbol.EndStatement, });
		...
		parsingTable.get(Symbol.StatementNoComment).put(Symbol.COMPOUND_IF, new Symbol[] {Symbol.COMPOUND_IF, Symbol.OptionalComment, Symbol.IfMore, Symbol.StatementNoComment, Symbol.EndStatement, });
		...
		parsingTable.get(Symbol.IfMore).put(Symbol.OpenParenthesis, new Symbol[] {});
		parsingTable.get(Symbol.IfMore).put(Symbol.String, new Symbol[] {});
		...
		parsingTable.get(Symbol.IfMore).put(Symbol.COMPOUND_ELSEIF, new Symbol[] {Symbol.COMPOUND_ELSEIF, Symbol.OptionalComment, Symbol.IfMore, });
		parsingTable.get(Symbol.IfMore).put(Symbol.Number, new Symbol[] {});
		parsingTable.get(Symbol.IfMore).put(Symbol.COMPOUND_IF, new Symbol[] {});
