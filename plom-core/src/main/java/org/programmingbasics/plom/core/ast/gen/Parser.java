...
public class Parser
{
	public Map<Symbol, Map<Symbol, Symbol[]>> parsingTable = new HashMap<>();
	{
		...
		parsingTable.get(Symbol.Expression).put(Symbol.TrueLiteral, new Symbol[] {Symbol.AdditiveExpression, });
		parsingTable.get(Symbol.Expression).put(Symbol.OpenParenthesis, new Symbol[] {Symbol.AdditiveExpression, });
		parsingTable.get(Symbol.Expression).put(Symbol.FalseLiteral, new Symbol[] {Symbol.AdditiveExpression, });
