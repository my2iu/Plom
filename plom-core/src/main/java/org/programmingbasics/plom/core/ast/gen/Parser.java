...
public class Parser
{
	public Map<Symbol, Map<Symbol, Symbol[]>> parsingTable = new HashMap<>();
	{
		...
		parsingTable.put(Symbol.IsAsExpression, new HashMap<>());
		parsingTable.get(Symbol.IsAsExpression).put(Symbol.AtType, new Symbol[] {Symbol.ParenthesisExpression, Symbol.IsAsExpressionMore, });
		parsingTable.get(Symbol.IsAsExpression).put(Symbol.DotVariable, new Symbol[] {Symbol.ParenthesisExpression, Symbol.IsAsExpressionMore, });
		parsingTable.get(Symbol.IsAsExpression).put(Symbol.FalseLiteral, new Symbol[] {Symbol.ParenthesisExpression, Symbol.IsAsExpressionMore, });
		parsingTable.get(Symbol.IsAsExpression).put(Symbol.NullLiteral, new Symbol[] {Symbol.ParenthesisExpression, Symbol.IsAsExpressionMore, });
		parsingTable.get(Symbol.IsAsExpression).put(Symbol.Number, new Symbol[] {Symbol.ParenthesisExpression, Symbol.IsAsExpressionMore, });
		parsingTable.get(Symbol.IsAsExpression).put(Symbol.OpenParenthesis, new Symbol[] {Symbol.ParenthesisExpression, Symbol.IsAsExpressionMore, });
		parsingTable.get(Symbol.IsAsExpression).put(Symbol.String, new Symbol[] {Symbol.ParenthesisExpression, Symbol.IsAsExpressionMore, });
		parsingTable.get(Symbol.IsAsExpression).put(Symbol.This, new Symbol[] {Symbol.ParenthesisExpression, Symbol.IsAsExpressionMore, });
		parsingTable.get(Symbol.IsAsExpression).put(Symbol.TrueLiteral, new Symbol[] {Symbol.ParenthesisExpression, Symbol.IsAsExpressionMore, });
		parsingTable.put(Symbol.IsAsExpressionMore, new HashMap<>());
		parsingTable.get(Symbol.IsAsExpressionMore).put(Symbol.And, new Symbol[] {});
		parsingTable.get(Symbol.IsAsExpressionMore).put(Symbol.As, new Symbol[] {Symbol.As, Symbol.AtType, Symbol.IsAsExpressionMore, });
		parsingTable.get(Symbol.IsAsExpressionMore).put(Symbol.Assignment, new Symbol[] {});
		parsingTable.get(Symbol.IsAsExpressionMore).put(Symbol.ClosedParenthesis, new Symbol[] {});
		parsingTable.get(Symbol.IsAsExpressionMore).put(Symbol.Divide, new Symbol[] {});
		parsingTable.get(Symbol.IsAsExpressionMore).put(Symbol.DotVariable, new Symbol[] {});
		parsingTable.get(Symbol.IsAsExpressionMore).put(Symbol.EndStatement, new Symbol[] {});
		parsingTable.get(Symbol.IsAsExpressionMore).put(Symbol.Eq, new Symbol[] {});
		parsingTable.get(Symbol.IsAsExpressionMore).put(Symbol.Ge, new Symbol[] {});
		parsingTable.get(Symbol.IsAsExpressionMore).put(Symbol.Gt, new Symbol[] {});
		parsingTable.get(Symbol.IsAsExpressionMore).put(Symbol.Is, new Symbol[] {Symbol.Is, Symbol.AtType, Symbol.IsAsExpressionMore, });
		parsingTable.get(Symbol.IsAsExpressionMore).put(Symbol.Le, new Symbol[] {});
		parsingTable.get(Symbol.IsAsExpressionMore).put(Symbol.Lt, new Symbol[] {});
		parsingTable.get(Symbol.IsAsExpressionMore).put(Symbol.Minus, new Symbol[] {});
		parsingTable.get(Symbol.IsAsExpressionMore).put(Symbol.Multiply, new Symbol[] {});
		parsingTable.get(Symbol.IsAsExpressionMore).put(Symbol.Ne, new Symbol[] {});
		parsingTable.get(Symbol.IsAsExpressionMore).put(Symbol.Or, new Symbol[] {});
		parsingTable.get(Symbol.IsAsExpressionMore).put(Symbol.Plus, new Symbol[] {});
		parsingTable.get(Symbol.IsAsExpressionMore).put(Symbol.Retype, new Symbol[] {});
		parsingTable.put(Symbol.MemberExpression, new HashMap<>());
		parsingTable.get(Symbol.MemberExpression).put(Symbol.AtType, new Symbol[] {Symbol.IsAsExpression, Symbol.MemberExpressionMore, });
		parsingTable.get(Symbol.MemberExpression).put(Symbol.DotVariable, new Symbol[] {Symbol.IsAsExpression, Symbol.MemberExpressionMore, });
		parsingTable.get(Symbol.MemberExpression).put(Symbol.FalseLiteral, new Symbol[] {Symbol.IsAsExpression, Symbol.MemberExpressionMore, });
		parsingTable.get(Symbol.MemberExpression).put(Symbol.NullLiteral, new Symbol[] {Symbol.IsAsExpression, Symbol.MemberExpressionMore, });
		parsingTable.get(Symbol.MemberExpression).put(Symbol.Number, new Symbol[] {Symbol.IsAsExpression, Symbol.MemberExpressionMore, });
		parsingTable.get(Symbol.MemberExpression).put(Symbol.OpenParenthesis, new Symbol[] {Symbol.IsAsExpression, Symbol.MemberExpressionMore, });
		parsingTable.get(Symbol.MemberExpression).put(Symbol.String, new Symbol[] {Symbol.IsAsExpression, Symbol.MemberExpressionMore, });
		parsingTable.get(Symbol.MemberExpression).put(Symbol.This, new Symbol[] {Symbol.IsAsExpression, Symbol.MemberExpressionMore, });
		parsingTable.get(Symbol.MemberExpression).put(Symbol.TrueLiteral, new Symbol[] {Symbol.IsAsExpression, Symbol.MemberExpressionMore, });
