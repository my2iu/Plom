...
public class Parser
{
	public Map<Symbol, Map<Symbol, Symbol[]>> parsingTable = new HashMap<>();
	{
		...
		parsingTable.get(Symbol.AndExpression).put(Symbol.FalseLiteral, new Symbol[] {Symbol.RelationalExpression, });
		parsingTable.get(Symbol.AndExpression).put(Symbol.AtType, new Symbol[] {Symbol.RelationalExpression, });
		parsingTable.get(Symbol.AndExpression).put(Symbol.DotVariable, new Symbol[] {Symbol.RelationalExpression, });
		parsingTable.get(Symbol.AndExpression).put(Symbol.Number, new Symbol[] {Symbol.RelationalExpression, });
		parsingTable.get(Symbol.AndExpression).put(Symbol.String, new Symbol[] {Symbol.RelationalExpression, });
		parsingTable.get(Symbol.AndExpression).put(Symbol.OpenParenthesis, new Symbol[] {Symbol.RelationalExpression, });
		parsingTable.get(Symbol.AndExpression).put(Symbol.TrueLiteral, new Symbol[] {Symbol.RelationalExpression, });
		parsingTable.get(Symbol.AndExpression).put(Symbol.This, new Symbol[] {Symbol.RelationalExpression, });
		parsingTable.get(Symbol.AndExpression).put(Symbol.NullLiteral, new Symbol[] {Symbol.RelationalExpression, });
		...
		parsingTable.get(Symbol.OrExpression).put(Symbol.FalseLiteral, new Symbol[] {Symbol.AndExpression, Symbol.AndExpressionMore, });
		parsingTable.get(Symbol.OrExpression).put(Symbol.AtType, new Symbol[] {Symbol.AndExpression, Symbol.AndExpressionMore, });
		parsingTable.get(Symbol.OrExpression).put(Symbol.DotVariable, new Symbol[] {Symbol.AndExpression, Symbol.AndExpressionMore, });
		parsingTable.get(Symbol.OrExpression).put(Symbol.Number, new Symbol[] {Symbol.AndExpression, Symbol.AndExpressionMore, });
		parsingTable.get(Symbol.OrExpression).put(Symbol.String, new Symbol[] {Symbol.AndExpression, Symbol.AndExpressionMore, });
		parsingTable.get(Symbol.OrExpression).put(Symbol.OpenParenthesis, new Symbol[] {Symbol.AndExpression, Symbol.AndExpressionMore, });
		parsingTable.get(Symbol.OrExpression).put(Symbol.TrueLiteral, new Symbol[] {Symbol.AndExpression, Symbol.AndExpressionMore, });
		parsingTable.get(Symbol.OrExpression).put(Symbol.This, new Symbol[] {Symbol.AndExpression, Symbol.AndExpressionMore, });
		parsingTable.get(Symbol.OrExpression).put(Symbol.NullLiteral, new Symbol[] {Symbol.AndExpression, Symbol.AndExpressionMore, });
		parsingTable.put(Symbol.Expression, new HashMap<>());
		parsingTable.get(Symbol.Expression).put(Symbol.FalseLiteral, new Symbol[] {Symbol.OrExpression, Symbol.OrExpressionMore, });
		parsingTable.get(Symbol.Expression).put(Symbol.AtType, new Symbol[] {Symbol.OrExpression, Symbol.OrExpressionMore, });
		parsingTable.get(Symbol.Expression).put(Symbol.DotVariable, new Symbol[] {Symbol.OrExpression, Symbol.OrExpressionMore, });
		parsingTable.get(Symbol.Expression).put(Symbol.Number, new Symbol[] {Symbol.OrExpression, Symbol.OrExpressionMore, });
		parsingTable.get(Symbol.Expression).put(Symbol.String, new Symbol[] {Symbol.OrExpression, Symbol.OrExpressionMore, });
		parsingTable.get(Symbol.Expression).put(Symbol.OpenParenthesis, new Symbol[] {Symbol.OrExpression, Symbol.OrExpressionMore, });
		parsingTable.get(Symbol.Expression).put(Symbol.TrueLiteral, new Symbol[] {Symbol.OrExpression, Symbol.OrExpressionMore, });
		parsingTable.get(Symbol.Expression).put(Symbol.This, new Symbol[] {Symbol.OrExpression, Symbol.OrExpressionMore, });
		parsingTable.get(Symbol.Expression).put(Symbol.NullLiteral, new Symbol[] {Symbol.OrExpression, Symbol.OrExpressionMore, });
