...
public class PlomAstGen
{
  ...
  Production[] grammar = new Production[] {
      ...
      rule(MemberExpression, IsAsExpression, MemberExpressionMore),
      rule(MemberExpressionMore, DotMember, MemberExpressionMore),
      rule(MemberExpressionMore),
      rule(IsAsExpression, ParenthesisExpression, IsAsExpressionMore),
      rule(IsAsExpressionMore, Is, AtType, IsAsExpressionMore),
      rule(IsAsExpressionMore, As, AtType, IsAsExpressionMore),
      rule(IsAsExpressionMore),
